...
/**
 * Interface representing the operations that a FlipFitGym Owner can perform.
...
public interface FlipFitGymOwnerService {
     ...
     */
    List<FlipFitGym> viewMyGyms(int gymOwnerId);
     ...
     *
     * @param gym the FlipFitGym object containing updated gym details
