...
import com.flipfit.business.FlipFitGymOwnerServiceOperations;
import com.flipfit.validator.ValidateCredential;
import com.flipfit.validator.ValidateIdentity;
...
public class FlipFitGymOwnerClientMenu {
    ...
    private FlipFitGymOwnerServiceOperations gymOwnerServiceOperations = new FlipFitGymOwnerServiceOperations();
    ...
    /// @param email FlipFitGym owner's email address.
    /// @param password FlipFitGym owner's password.
    ...
    public boolean gymOwnerLogin(String email, String password) {
        ...
        System.out.println( "Login Successful! (FlipFitGym Owner)" );
        displayCurrentDate();
        while (true) {
            System.out.println(  "-----------------FlipFitGym Owner Menu-----------------" );
            ...
            switch (choice) {
                ...
                case 6:
                    if (updateGymOwnerDetails())
                        System.out.println( "FlipFitGym owner updated successfully!" );
                    else
                        System.out.println( "FlipFitGym owner not updated" );
                    break;
                case 7:
                    return true;
                default:
    ...
    /// @param email FlipFitGym owner's email address (used to fetch the owner ID).
    private void addGym(String email) {
        ...
        while (currentCount <= slotCount) {
            ...
            FlipFitSlots slot = new FlipFitSlots(-1, startTime, seatCount);
            slots.add(slot);
            currentCount++;
        }
        ...
        if (gymOwnerServiceOperations.addGym(gym))
            System.out.println( "FlipFitGym added successfully!" );
        else
            System.out.println( "FlipFitGym could not be added!" );
    }
    ...
    public void createGymOwner() {
        ...
        if (gymOwnerServiceOperations.createGymOwner(gymOwner)) {
            System.out.println( "FlipFitGym owner created!" );
        } else {
            System.out.println( "FlipFitGym owner not created!" );
        }
    }
    ...
    /// @param userMail FlipFitGym owner's email address.
    ...
    private void displayGyms(String email) {
        ...
        List<FlipFitGym> gymsList = gymOwnerServiceOperations.viewMyGyms(gymOwnerId);
        if (gymsList.isEmpty()) {
        ...
        for (FlipFitGym gym : gymsList) {
            System.out.format("+-------+----------------------+------------------------------------------+----------------------+\n");
            System.out.format("| FlipFitGym ID|     Name             |           Address                        |     Location         |\n");
            System.out.format("+-------+----------------------+------------------------------------------+----------------------+\n");
    ...
    public boolean updateGym(String email) {
        ...
        System.out.println( "Name: " );
        String gymName = scanner.nextLine();
        System.out.println( "FlipFitGym Address: " );
        ...
        System.out.println( "FlipFitGym Location: " );
