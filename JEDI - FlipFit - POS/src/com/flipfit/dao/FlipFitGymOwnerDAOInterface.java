...
public interface FlipFitGymOwnerDAOInterface {
     ...
     * @return  A list of FlipFitGym objects representing the gyms owned by the specified owner. If the owner has no gyms or the ID is invalid, an empty list is returned.
     */
    List<FlipFitGym> viewMyGyms(int ownerId);
     ...
     * @param gym The FlipFitGym object containing the details of the new gym, including attributes such as name, location, facilities, and other relevant information.
    ...
    boolean addSlots(int gymId, List<FlipFitSlots> slots);
    ...
    List<FlipFitSlots> getSlotsByGymId(int gymId);
     ...
     * @param gym FlipFitGym object with the updated details of the FlipFitGym
     * @return  true if the update is successful, false otherwise
     */
    boolean updateGymDetails(FlipFitGym gym);
}
