...
public interface FlipFitCustomerDAOInterface {
    ...
    List<FlipFitBookings> getAllBookingsByUserID(int userId);
    ...
    FlipFitBookings getBooking(int bookingId);
     ...
     * @param user - The FlipFitUser object containing the updated details of the user.
     ...
     * @return  A list of FlipFitGym objects representing gyms with available slots.
     */
     ...
     * @return A list of FlipFitGym objects representing gyms located in the specified area. If no gyms are found in the given area, an empty list is returned.
     */
