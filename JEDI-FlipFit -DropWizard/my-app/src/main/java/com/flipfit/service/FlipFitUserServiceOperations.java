...
import com.flipfit.dao.FlipFitCustomerDAOImplementation;
 ...
 * Implements FlipFitUserService interface.
 *
 */
public class FlipFitUserServiceOperations implements FlipFitUserService {
     ...
     */
    public List<FlipFitBookings> viewAllBookings(int userId) {
